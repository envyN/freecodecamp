...
function partitionwithMoTPivot(array, startIndex, endIndex) {
    ...
    swap(array, midIndex, endIndex);
    // take the median of three numbers as the pivot
...
function quickSort(array, start, end) {
    ...
    if (start < end) {
        let pivotIndex = partitionwithMoTPivot(array, start, end);
